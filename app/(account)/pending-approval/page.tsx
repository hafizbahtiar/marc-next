...
function paymentDescription(status: string | null, feeCents: number | null): string {
  const amount = feeCents == null ? null : formatCurrency(feeCents);
  ...
  switch (status) {
    ...
    case "failed":
      return amount
        ? `Pembayaran terakhir tidak berjaya. Yuran pendaftaran ialah ${amount}. Cuba semula melalui aplikasi MARC.`
    ...
    default:
      return amount
        ? `Yuran pendaftaran ${amount} belum dibayar. Pembayaran boleh dibuat melalui aplikasi MARC.`
